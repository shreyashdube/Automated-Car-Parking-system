...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jPanel6.getAccessibleContext().setAccessibleName("Count Parked");

        setSize(new java.awt.Dimension(926, 716));
   ...
   public void status(){
       try{
        ...
        long diff =0;
           ...
           exDate = (java.util.Date) new SimpleDateFormat("dd-MMM-yyyy").parse(ex); //ed
